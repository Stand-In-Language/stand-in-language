...
-- creates a termBuilder that preserves existing function indexes
{-
toTerm3Builder :: (Base g ~ f, StuckBase f, Recursive g, Corecursive g) => g -> Term3Builder g
toTerm3Builder t = cata f  where
  f = \case
